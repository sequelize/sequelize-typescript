...
describe('instance', () => {
  ...
  describe('reload', () => {
    ...
    it('should update read only attributes as well (updatedAt)', () => {
      return this.User.create({ username: 'John Doe' }).bind(this).then((originalUser) => {
  ...
  describe('save', () => {
    ...
    it('does not update timestamps when passing silent=true', () => {
      return this.User.create({ username: 'user' }).bind(this).then((user) => {
    ...
    it('does not update timestamps when passing silent=true in a bulk update', () => {
      ...
      return this.User.bulkCreate(data).bind(this).then(() => {
