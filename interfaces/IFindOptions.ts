...
export interface IFindOptions extends LoggingOptions, SearchPathOptions {
   ...
   */
  order?: string | col | literal | Array<string | number | typeof Model | { model : typeof Model, as? : string}> | Array<string | col | literal | Array<string | number | typeof Model | { model : typeof Model, as? : string}>>;
