...
export declare abstract class Model<T extends Model<T>> extends Hooks {
  ...
  constructor(values?: FilteredModelAttributes<T>, options?: IBuildOptions<Model<T>>);
   ...
   */
  static build<T extends Model<T>>(this: (new () => T), record?: FilteredModelAttributes<T>, options?: IBuildOptions<T>): T;
  static build<T extends Model<T>, A>(this: (new () => T), record?: A, options?: IBuildOptions<T>): T;

  /**
   * Undocumented bulkBuild
   */
  static bulkBuild<T extends Model<T>>(this: (new () => T), records: FilteredModelAttributes<T>[], options?: IBuildOptions<T>): T[];
  static bulkBuild<T extends Model<T>, A>(this: (new () => T), records: A[], options?: IBuildOptions<T>): T[];

  /**
   * Builds a new model instance and calls save on it.
   */
  static create<T extends Model<T>>(this: (new () => T), values?: FilteredModelAttributes<T>, options?: ICreateOptions<T>): Promise<T>;
