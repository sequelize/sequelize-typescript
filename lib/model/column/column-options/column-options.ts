import {
  ColumnOptions as OriginalColumnOptions, DataTypeAbstract, DefineAttributeColumnReferencesOptions,
...
export interface ColumnOptions extends OriginalColumnOptions {
